...
<div class = "wrapper">
  <?php $query = "SELECT * FROM courses WHERE CourseID =".$_GET['id'];
       if(!$conn->query($query))
  ...
  ?>
<video src="/IS3-Online-Tutoring/resources/CoursesContent/Videos/<?php echo $row['Overview']?>" autoplay controls> </video>
...
<?php
    ...
    while($row =$result->fetch_array(MYSQLI_ASSOC)){
        $chaptersCount+=1;
        $title=  $row['Title'];
        echo "<a href=/IS3-Online-Tutoring/src/view/viewChapterContent.php?id=$id&ch=$chaptersCount>Chapter $chaptersCount: $title </a>"; 
        echo "<br>";
}
?>
